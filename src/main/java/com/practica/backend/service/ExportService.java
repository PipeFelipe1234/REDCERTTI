...
public class ExportService {
    ...
    // Resumen
    XWPFParagraph resumenParagraph = document.createParagraph();resumenParagraph.setSpacingBefore(400);
    XWPFRun resumenRun = resumenParagraph
            .createRun();resumenRun.addBreak();resumenRun.setText("Total de registros: "+registros.size());resumenRun.setBold(true);
